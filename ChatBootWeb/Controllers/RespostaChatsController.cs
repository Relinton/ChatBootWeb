...
namespace ChatBootWeb.Controllers
{
    public class RespostaChatsController : Controller
    {
        ...
        {
            return View(_context.RespostaChat.ToList());
        }
        ...
        [HttpPost("api/Chat")]
        public JsonResult Chat(RequestApi request)
        {
            var respostaChat = _context.RespostaChat.Where(m => m.Mensagem.ToUpper().Contains(request.mensagem.ToUpper())).FirstOrDefault();
